...
export interface Mutation {
  SendChatMessage: SendChatMessageReponse;
  ...
  RequestEmailVerification: RequestEmailVerificationResponse;
  StartPhoneVerfification: StartPhoneVerfificationResponse;
  ToggleDrivingMode: ToggleDrivingModeResoponse;
...
export interface StartPhoneVerfificationMutationArgs {
  phoneNumber: string;
}
...
export interface SendChatMessageReponse {
  ok: boolean;
  error: string | null;
...
export interface StartPhoneVerfificationResponse {
  ok: boolean;
  error: string | null;
}

export interface ToggleDrivingModeResoponse {
  ok: boolean;
  error: string | null;
}
